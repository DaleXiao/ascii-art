...
export const DICT = {
  en: {
    ...
    footerDesc: 'Any image format → ASCII art: drag & drop or paste to convert, adjust width/saturation/brightness/gamma, export as PNG or TXT. Free, no signup — everything runs locally in your browser, images never uploaded.',
    seoTitle: 'ASCII Art Converter — Image to ASCII Art · Free Online',
  ...
  zh: {
    ...
    footerDesc: '任意格式图片 → ASCII 字符画：拖拽或粘贴即转，宽度/饱和度/亮度/伽马可调，PNG·TXT 导出。免费、无需注册 —— 全程浏览器本地运行，图片绝不上传。',
